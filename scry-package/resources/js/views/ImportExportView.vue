<template>
  <div class="flex-1 p-6 overflow-y-auto scry-bg-app">
    <div class="mb-6">
      ...
      <p class="text-sm scry-text-muted">Import datasets or export schemas into CSV, SQL, XML, PDF, JSON, and LaTeX formats for <span class="font-mono scry-accent-text font-bold">[{{ store.currentConnection }}]</span>.</p>
    </div>
        ...
        <div>
          ...
          <div class="space-y-4">
            ...
            <div v-if="exportTable" class="grid grid-cols-2 gap-2 pt-2">
              <a
                v-for="fmt in ['csv', 'sql', 'xml', 'pdf', 'json', 'latex']"
                :key="fmt"
